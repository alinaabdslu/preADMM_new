...
comparison_dataset_3 = function(repetitions){
  ...
  inside_function = function(){
    ...
    M_4_original = as.matrix(net_original[[4]])
    M_5_original = as.matrix(net_original[[5]])
    
    M_1_new = as.matrix(net_new[[1]])
    M_2_new = as.matrix(net_new[[2]])
    M_3_new = as.matrix(net_new[[3]])
    M_4_new = as.matrix(net_new[[4]])
    M_5_new = as.matrix(net_new[[5]])
    
    M_1 = M_1_new - M_1_original
    M_2 = M_2_new - M_2_original
    M_3 = M_3_new - M_3_original
    M_4 = M_4_new - M_4_original
    M_5 = M_5_new - M_5_original
  ...
  difference_4 = mean(result[4,])
  difference_5 = mean(result[5,])
  
  data_tsib <- tsibble(
    value = c(difference_1, difference_2, difference_3, difference_4, difference_5),
    Index = c(1, 2, 3, 4, 5),
    index = Index
  )
